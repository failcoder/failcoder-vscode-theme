...
export class VscodeThemeGenerator implements IThemeGenerator {
  ...
  private _applyWorkbenchColors(theme: IVscodeJsonTheme,  colorSet: IColorSet): void {
    ...
    theme.colors['focusBorder'] = colorSet.base.accent;
    ...
    theme.colors['inputOption.activeBorder'] = colorSet.base.accent;
    ...
    theme.colors['list.activeSelectionBackground'] = addAlpha(colorSet.base.accent, 0.5);
    // list.activeSelectionForeground: List/Tree foreground color for the selected item when the list/tree is active. An active list/tree has keyboard focus, an inactive does not.
    // list.dropBackground: List/Tree drag and drop background when moving items around using the mouse.
    theme.colors['list.dropBackground'] = addAlpha(colorSet.base.accent, 0.5);
    ...
    theme.colors['list.focusBackground'] = addAlpha(colorSet.base.accent, 0.5);
    ...
    theme.colors['activityBar.dropBackground'] = addAlpha(colorSet.base.accent, 0.5);
    ...
    theme.colors['activityBarBadge.background'] = colorSet.base.accent;
    ...
    theme.colors['editorGroup.dropBackground'] = addAlpha(colorSet.base.accent, 0.5);
    ...
    theme.colors['tab.activeBorder'] = colorSet.base.accent;
    ...
    theme.colors['editorLineNumber.activeForeground'] = colorSet.base.accent;
    ...
    theme.colors['peekView.border'] = colorSet.base.accent;
    ...
    theme.colors['statusBar.debuggingBackground'] = colorSet.base.accent;
    ...
    theme.colors['statusBarItem.activeBackground'] = addAlpha(colorSet.base.accent, 0.5);
    ...
    theme.colors['selection.background'] = colorSet.base.accent;
